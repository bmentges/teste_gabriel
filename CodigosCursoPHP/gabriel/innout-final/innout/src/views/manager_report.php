<main class="content">
    ...
    <div class="summary-boxes">
        <div class="summary-box bg-primary">
            ...
            <p class="title">Qtde. Colaboradores</p>
    ...
    <?php if(count($absentUsers) > 0): ?>
        <div class="card mt-4">
            <div class="card-header">
                <h4 class="card-title">Quem faltou hoje?</h4>
                <p class="card-category mb-0">Relação dos funcionários que ainda não marcaram o ponto</p>
            </div>
            <div class="card-body">
