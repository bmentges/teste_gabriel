<nav class="modulos">
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=basico&file=comentarios">Comentários CSS</a></li>
    ...
    <div class="modulo roxo">
        <h3>4. Est. de Controle</h3>
        <ul>
            <li><a href="exercicio.php?dir=controles&file=if_else">If / Else</a></li>
            <li><a href="exercicio.php?dir=controles&file=operadores_relacionais">Operadores Relacionais</a></li>
            <li><a href="exercicio.php?dir=controles&file=desafio_pi">Desafio PI</a></li>
            <li><a href="exercicio.php?dir=controles&file=operadores_logicos">Operadores Lógicos</a></li>
            <li><a href="exercicio.php?dir=controles&file=desafio_operadores">Desafio Operadores</a></li>
            <li><a href="exercicio.php?dir=controles&file=operador_ternario">Operador Ternário</a></li>
            <li><a href="exercicio.php?dir=controles&file=switch">Switch</a></li>
            <li><a href="exercicio.php?dir=controles&file=desafio_switch">Desafio Switch</a></li>
        </ul>
    </div>
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=classes_objetos&file=magicos">Métodos Mágicos</a></li>
